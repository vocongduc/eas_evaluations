...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="head-action row mb-5">
            <div class="col-2">
                <h4 class="">Quản lý Tiêu chí </h4>
            </div>
            <div class="col-4">
                <!-- Search user -->
                <form action="{{route('criterias.index')}}" method="get">
                    <div class="input-group md-form form-sm form-2 pl-0 ">
                        <input class="form-control my-0 py-1 red-border" type="text" placeholder="Tìm kiếm" aria-label="Search" name="search_criteria">
            ...
            <div class="col-6" style="padding-right: 100px;">
                ...
                <div class="d-flex justify-content-end align-items-center ">
                    <a href="{{  route('criterias.create')}}" class="create-modal"  title="Thêm Danh mục" >
    ...
    <!-- Mainpoint list -->
        <table class="table table-hover mb-5" >
            ...
            <tr>
                <th>STT</th>
                <th class="text-left">Tên tiêu chí </th>
                <th>Tên danh mục </th>
                <th>Trọng số </th>
                <th>Điểm tuyệt đối </th>
                <th>Hành động </th>
            </tr>
            </thead>
            <tbody>
            ...
            @foreach($criterias as $key => $criteria)
                <tr>
                    ...
                    <td class="text-left">{{$criteria->Category['name']}}</td>
                    <td class="text-left">{{$criteria->point_weight}}</td>
                    <td class="text-left">{{$criteria->point_max}}</td>
                    <td>
                        <a href="{{route('criterias.edit',$criteria->id)}}" style="text-decoration: none">
